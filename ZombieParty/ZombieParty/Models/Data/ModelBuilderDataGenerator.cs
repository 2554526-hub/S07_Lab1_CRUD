    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Long Sword", Description = "An awesome Long Steel Sword", Force = 150, Image = "https://www.pngkey.com/maxpic/u2y3a9r5q8u2e6w7/#google_vignette", Price = 340, Qty = 17, QtyBought = 12, CreatedDate = new DateTime(1999, 01, 1) }
            );
            #endregion
        }
    }
